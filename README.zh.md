...
> 13 个 AI 产品交互模式，纯前端实现，fork 下来就能跑 | [在线预览](https://paduma.github.io/aigc-playground/)
...
这个项目通过 vibe coding 方式构建 — 一种人机协作的开发模式，开发者主导产品决策、架构设计和质量把控，AI 辅助实现。

具体来说：

- 每个 demo 都由开发者亲自设计、审查和迭代
- AI（Kiro）辅助代码生成、bug 修复和功能实现
- 开发者对产品方向和代码质量保持完全控制

这不是 spec coding（AI 根据规格说明自主生成代码，人类参与度低）。Vibe coding 是深度协作 — 开发者全程参与，在 UX、架构和边界情况上做出 AI 无法独立完成的判断。

## 快速开始

**推荐 Fork 本项目**，方便你在自己的仓库里修改和实验：
...
| Demo        | 路由          | 看点                                       |
| ----------- | ------------- | ------------------------------------------ |
| AI 写作     | `/ai-writing` | 选中文字弹浮窗、润色/翻译/扩写、打字机续写 |
...
欢迎 Fork 和 PR。如果觉得有帮助，给个 ⭐ Star 就是最大的支持。
